...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:output method="xhtml" html-version="5" omit-xml-declaration="yes" include-content-type="no"
        indent="yes"/>
    <!--This was a portion of the DIGIT 110 Project worked on for "Undertale" with Ella and Jack, this is the version in my files for DIGIT 210-->
    
    <xsl:template match="/">
        <html>
            <head>
                <title>Asriel Dreemurr</title> <!--Had a comment on the project that the name was spelled wrong AHHHH-->
            ...
            <body>
                ...
                <h1>Asriel Dreemurr</h1> <!--There, now it's correct all over-->
